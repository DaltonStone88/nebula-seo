...
export default function BusinessSettings() {
  ...
  return (
    <div>
      <div style={{ padding: '22px 36px', borderBottom: '1px solid var(--border)', background: 'rgba(6,6,18,0.5)', backdropFilter: 'blur(10px)', position: 'sticky', top: 0, zIndex: 50, minHeight: 76, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
